...
const NAV_COLUMNS = [
  { heading: 'Invest',         items: ['Wealth Manager', 'Retail Investors'] },
  { heading: 'Company stock',  items: ['Overview', 'Track Price', 'Why Invest', 'FAQ'] },
  { heading: 'Product',        items: ['Active Deals', 'Portfolio', 'CRM', 'Market Intelligence', 'Secondary'] },
  { heading: 'Resources',      items: ['Blog', 'Case Studies', 'Testimonials'] },
  { heading: 'Company',        items: ['About Us', 'Team', 'Contacts'] },
]
    ...
    <footer className="w-full bg-page-bg" style={{ borderTop: '1px solid #222', position: 'relative', zIndex: 1 }}>
      ...
      >
        ...
        <div className="flex flex-col items-start gap-8 lg:justify-between lg:shrink-0 lg:w-[238px] lg:self-stretch">
          ...
          <div className="flex flex-col gap-6 items-start" style={{ opacity: 0 }}>
            {/* Address / contacts */}
