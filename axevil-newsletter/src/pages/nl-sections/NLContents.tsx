...
const CARDS = [
  ...
  },
  {
    ...
    text: (
      <>
        Объём заявок недели с разбивкой на покупку и продажу и имена,<br className="hidden md:inline" />
        {' '}которые ведут обе стороны. Видно, куда идут деньги и где нарастает навес.
      </>
    ),
  ...
  },
  {
    ...
    text: (
      <>
        Компании, по которым за неделю заявки шли только в одну сторону.<br className="hidden md:inline" />
        {' '}Односторонний спрос и односторонний выход быстрее всего показывают<br className="hidden md:inline" />
        {' '}смену отношения к имени.
      </>
    ),
  ...
  },
  {
    ...
    text: (
      <>
        Отчётность и выручка, новые раунды, M&A, лицензии и релизы у частных компаний.<br className="hidden md:inline" />
        {' '}Плюс крупнейшие раунды недели по размеру чека.
      </>
    ),
