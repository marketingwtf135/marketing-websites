...
/**
 * Пункты «Пример выпуска» и «Как это работает» убраны вместе со своими секциями
 * (2026-08-21) — ссылка вела бы в
 * никуда. Историю названия оставляю: «Методология» была переименована в «Пример выпуска»: на мобильной вёрстке сам раздел так и
 ...
 *
 * После этого в меню осталось два пункта, и оно выглядело пустым (Татьяна, 2026-08-21).
 * Добавлен «Кому полезен» — первый раздел страницы, которого в меню не было с самого
 * начала. Порядок пунктов совпадает с порядком разделов на странице: подсветка активного
 * пункта берёт верхний видимый раздел, и при расхождении порядка она прыгала бы.
 */
const NAV_LINKS = [
  { label: 'Кому полезен',     id: 'nl-audience'     },
