...
/**
 * Блок 7 из ТЗ — шесть вопросов с ответами.
 *
 * Единственный блок ТЗ, который отсутствовал целиком и при этом не требовал ничего
 * извне: формулировки заданы в самом ТЗ.
 *
 * Три ответа отошли от дословного текста ТЗ по указанию Павла (2026-08-04): инструментов
 * из ТЗ (калькулятор, IPO-календарь, sector heatmap, slide deck) в продукте нет, поэтому
 * упоминания доступа к ним убраны — обещать нечего; welcome-письмо теперь описано как
 * последний вышедший выпуск; день рассылки — среда, без времени.
 *
