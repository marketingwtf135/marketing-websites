...
function CtaCard({
  ...
  return (
    <div
      ...
      style={{ border: '1px solid #151515', width: 'min(710px, 100%)', minHeight: '660px' }}
    >
      ...
      <div className="relative flex flex-col h-full pt-8 pb-6 text-white z-10" style={{ paddingLeft: '2rem', paddingRight: '2rem' }}>
...
export default function Block12Cta() {
  return (
    <section className="relative w-full bg-page-bg" style={{ paddingBottom: 'clamp(3.75rem, 12.5vw, 12.5rem)', paddingTop: '6.25rem' }}>
      <div className="relative mx-auto w-full max-w-content container-px flex flex-col gap-15 items-center">
        ...
        <div className="flex flex-col md:flex-row items-stretch justify-between gap-5 w-full">
          ...
          <CtaCard
            ...
            ctaLabel="Request a Demo"
            device={
              <div className="absolute pointer-events-none" style={{ left: '360px', top: '190px', width: '779px', height: '545px', zIndex: 2 }}>
                <img alt="" src="/img/block10/laptop-app-image-02.png" className="w-full h-full object-contain object-left-top" loading="lazy" />
              </div>
            }
          />
        </div>
