...
export default function Block01Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Copy + CTA */}
      <div className="absolute w-full" style={{ bottom: '5rem', zIndex: 15 }}>
        <div className="mx-auto w-full max-w-content container-px">
          <div className="flex flex-col gap-12 items-start">
            <div className="flex flex-col gap-6 items-start">
              <h1
                className="font-inter-tight font-semibold leading-none tracking-[-0.02em] text-transparent bg-clip-text whitespace-pre-line"
                style={{
              ...
              <p className="font-inter-tight font-medium text-text-xl text-white/60" style={{ width: '100%', maxWidth: '37.75rem' }}>
