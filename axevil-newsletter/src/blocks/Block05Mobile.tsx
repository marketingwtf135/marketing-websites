...
export default function Block05Mobile() {
  ...
  return (
    ...
    <div ref={wrapperRef} className="w-full bg-page-bg" style={{ height: '200vh', marginTop: '12.5rem' }}>
      {/* Sticky inner — sticks 32px from top */}
      <div className="flex justify-center" style={{ position: 'sticky', top: '7.5rem' }}>
        <section
        ...
        >
          ...
          {/* Heading */}
          <h2 className="absolute font-inter-tight font-semibold text-white whitespace-pre-line" style={{ left: 'clamp(1.25rem, 4.2vw, 3.75rem)', top: '60px', fontSize: 'clamp(1.75rem, 4.2vw, 4rem)', lineHeight: 1 }}>
            {'Mobile app \nfor investor'}
          </h2>
