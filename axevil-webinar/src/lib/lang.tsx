...
export const translations = {
  en: {
    ...
    form: {
      ...
      sending: 'Sending...',
      success: {
        heading: 'To complete your registration, open our Telegram bot',
        subheading: 'As a gift — a report on key developments in the private companies market — Pre-IPO Insider by the Axevil analytics team.',
        primary: 'Get the report in Telegram',
        close: 'Close',
      },
  ...
  ru: {
    ...
    hero: {
      badge: 'ZOOM-ВСТРЕЧА · 4 ИЮНЯ · 19:00 МСК · 60 МИНУТ',
      heading: 'Как добавить Private markets в портфели HNWI-клиентов:',
      sub: 'Закрытая Zoom-встреча для управляющих капиталом, family offices и независимых инвестиционных советников.',
    ...
    whoFor: {
      ...
      cards: [
        { n: '1.0', title: 'Независимые финансовые советники', body: 'Расскажем про private markets как класс активов и разберём, как встраивать их в структуру клиентского портфеля: на что обращать внимание при отборе сделок и как выбирать провайдера.' },
        { n: '2.0', title: 'Family-офисы и управляющие капиталом', body: 'Вы знаете, что private markets создают альфу — вопрос в доступе, выборе инструмента и дисциплине. Разберём практические шаги, которые делают успешные family offices в сегменте private markets.' },
        { n: '3.0', title: 'Институциональные инвесторы и брокеры', body: 'Как расширить полку и продуктовое предложение для клиентов в private markets — без собственной инфраструктуры и разработки.' },
      ],
    },
    whyAxevil: {
    ...
    whatCover: {
      ...
      items: [
        { n: '1.0', body: 'Роль private markets в структуре портфеля — как private markets могут улучшать и балансировать портфель, увеличивая доходность и снижая риски.' },
        { n: '2.0', body: 'Текущая ситуация на рынке private markets — почему сейчас лучшее время для рынка частных компаний.' },
        { n: '3.0', body: 'Инфраструктура входа — legal инфраструктура и лучшие венчурные практики защиты капитала инвесторов.' },
        { n: '4.0', body: 'Топ-индустрии и технологические тренды, которые будут определять pre-IPO рынок в ближайшие несколько лет.' },
        { n: '5.0', body: 'Открытые инвестиционные возможности на платформе Axevil Capital и ответы на вопросы в прямом эфире.' },
      ],
    },
    speaker: {
    ...
    schedule: {
      ...
      rows: [
        ...
        { title: 'Инфраструктура входа', desc: 'Legal-инфраструктура и защита капитала', time: '0:20 — 0:30' },
        { title: 'Трендовые индустрии', desc: 'AI, финтех, диптех — куда идут инвесторы', time: '0:30 — 0:45' },
        { title: 'Сделки и Q&A', desc: 'Открытые возможности Axevil Capital и ваши вопросы', time: '0:45 — 1:00' },
      ],
    },
    form: {
      ...
      sending: 'Отправка...',
      success: {
        heading: 'Для завершения регистрации перейдите в Telegram-бота',
        subheading: 'В подарок — отчёт о ключевых событиях рынка частных компаний — Pre-IPO Insider от команды аналитиков Axevil.',
        primary: 'Закончить регистрацию и забрать отчёт',
        close: 'Закрыть',
      },
