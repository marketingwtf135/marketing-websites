  ...
  en: {
    ...
    form: {
      ...
      success: {
        ...
        subheading: 'One last step — open our Telegram bot to confirm and complete your registration.',
  ...
  ru: {
    ...
    form: {
      ...
      success: {
        ...
        subheading: 'Остался последний шаг — перейдите в Telegram-бота, чтобы подтвердить регистрацию и завершить запись.',
